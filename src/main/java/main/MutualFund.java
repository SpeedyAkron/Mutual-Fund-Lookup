...
public class MutualFund{
	...
	private String abreviatedCategory = "";
	...
	private String oneYearReturnVsCategory = "";
	private String threeYearReturnVsCategory = "";
	private String fiveYearReturnVsCategory = "";
	...
	public void setCategoryAndAbreviatedCategory(String category) {
		category = replaceFundCategories(category);		
		this.category = replaceFundCategories(category);

		if(category.length()<2){
			abreviatedCategory = category;
		}
		else if(category.substring(0, 2).equalsIgnoreCase("EM")){ 
			abreviatedCategory = "EM";//Emerging markets gets two letters
		}
		else{
			abreviatedCategory = category.substring(0, 1);
		}
...
//	}
	...
	public void setOneYearReturnVsCategory(String oneYearReturnVsCategory) {
		this.oneYearReturnVsCategory = oneYearReturnVsCategory;
	}

	public void setThreeYearReturnVsCategory(String threeYearReturnVsCategory) {
		this.threeYearReturnVsCategory = threeYearReturnVsCategory;
	}

	public void setFiveYearReturnVsCategory(String fiveYearReturnVsCategory) {
		this.fiveYearReturnVsCategory = fiveYearReturnVsCategory;
	}
	...
	public void setFirstManagerStartDate(String firstManagerStartDate) {
		this.firstManagerStartDate = firstManagerStartDate;
	}

	public void setLastManagerStartDate(String lastManagerStartDate) {
		this.lastManagerStartDate = lastManagerStartDate;
	}

	public void setReturnVsCatYearsAgo(String returnVsCatSixYearsAgo, int numYearsAgo) {
	...
	public String getFundTextExcel(){
		return tickerSymbol + DEL 
				...
				+ oneYearReturn + DEL 
				+ threeYearReturn + DEL 
				+ oneYearReturnVsCategory + DEL 
				+ threeYearReturnVsCategory + DEL 
				+ fiveYearReturnVsCategory + DEL 
	...
	private long daysSince1900(int numYearsAgo) {	
		...
		int year = now.get(Calendar.YEAR) - numYearsAgo;
		...
		long difference = (date.getTime() - date1900.getTime()) / 1000 / 60 / 60 / 24;
